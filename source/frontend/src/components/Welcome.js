...
/* Welcome page for user to log or register to their account, this page only consist of links */
function Welcome() {
  return (
    <>
    <Grid
    ...
    <Grid item xs={3}>
        <div>You can either <a href="/login">Log in</a>  or <a href="/register">Register</a></div>
      </Grid>   
